...
get_stats() {
    ...
    Mem=($(free -b | grep Mem))
    echo -n $(echo "scale=3;x=${Mem[1]}/1073741824; if(x<1) print 0; x" | bc); echo " GB"
    echo -n $(echo "scale=3;x=${Mem[2]}/1073741824; if(x<1) print 0; x" | bc); echo " GB"
    echo -n $(echo "scale=3;x=${Mem[3]}/1073741824; if(x<1) print 0; x" | bc); echo " GB"
    
    # Сбор и вывод данных о дисковом пространстве
    Space=($(df -B1 / | grep /))
    echo -n  $(echo "scale=2;x=${Space[1]}/1048576; if(x<1) print 0; x" | bc); echo " MB"
    echo -n  $(echo "scale=2;x=${Space[2]}/1048576; if(x<1) print 0; x" | bc); echo " MB"
    echo -n  $(echo "scale=2;x=${Space[3]}/1048576; if(x<1) print 0; x" | bc); echo " MB"
}
